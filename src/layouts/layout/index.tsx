                ...
                <div className="flex flex-column h-full">
                    <div className="flex align-items-center justify-content-between px-4 pt-3 flex-shrink-0">
                        ...
                        <Link to={"/home"} className="flex align-items-center">
                            <Image src="/images/logo/logo_riffhouse_white.png"
                                alt="RiffHouse Logo"
                                width="150px"
                            ></Image>
                        </Link>
                    ...
                    <div className="overflow-y-auto">
                        <ul className="list-none p-3 m-0">
                            ...
                            <li>
                                <Link to={"/categories"} className="p-ripple flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-full no-underline">
                    ...
                    <div className="mt-auto w-full">
                        <hr className="mb-3 mx-3 border-top-1 border-none surface-border" />
                                    <Menu model={menuItems} popup ref={menuRef} id="popup_menu_right" popupAlignment="right" />

                        <Button outlined className="w-full border-0" onClick={(event) => menuRef.current?.toggle(event)} aria-controls="popup_menu_right" aria-haspopup>

                            <Avatar
                                image="https://primefaces.org/cdn/primereact/images/avatar/amyelsner.png"
                                shape="circle"
                            />
                            <span className="font-bold">{authenticatedUser?.email || "Admin"}</span>
                            </Button>
                    </div>
                </div>
            </div>
